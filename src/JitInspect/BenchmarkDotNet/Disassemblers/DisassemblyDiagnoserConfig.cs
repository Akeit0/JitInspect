...
public class DisassemblyDiagnoserConfig
{
    ...
    {
        if (!(syntax is DisassemblySyntax.Masm or DisassemblySyntax.Intel or DisassemblySyntax.Att)) throw new ArgumentOutOfRangeException(nameof(syntax), syntax, "Invalid syntax");
    ...
    static FormatterOptions GetDefaults(DisassemblySyntax syntax)
    {
        var options = syntax switch
        {
